...
- ```ip a (ws1, ws2)```<br>
![alt text](./devops/6.png)<br>


- ```Описан сетевой интерфейс, соответствующий внутренней сети, на обеих машинах и заданы следующие адреса и маски: ws1 - 192.168.100.10, маска /16, ws2 - 172.24.116.8, маска /12. Код для ws2 выглядит так же, за исключением адреса и маски.```<br>
![alt text](./devops/7.png)<br>


- ```netplan apply```<br>
![alt text](./devops/8.png)<br>

### 2.1. Добавление статического маршрута вручную


- ```Команды для добаления статического маршрута, пинг```<br>
![alt text](./devops/9.png)<br>

### 2.2. Добавление статического маршрута с сохранением

- ```Изменённые файлы etc/netplan/00-installer-config.yaml```<br>
![alt text](./devops/11.png)<br>

- ```Пропинговали ещё раз```<br>
![alt text](./devops/10.png)<br>
...
![alt text](./devops/13.png)<br>

- ```Запуска файлов на обеих машинах```<br>
![alt text](./devops/14.png)<br>
...
- ```Ping + nmap```<br>
![alt text](./devops/15.png)<br>

## Part 5. Статическая маршрутизация сети

### Cкрины с содержанием файла etc/netplan/00-installer-config.yaml для каждой машины:
- ```WS11```<br>
![alt text](./devops/16.png)<br>

- ```R1```<br>
![alt text](./devops/17.png)<br>

- ```WS21```<br>
![alt text](./devops/18.png)<br>

- ```WS22```<br>
![alt text](./devops/19.png)<br>

- ```R2```<br>
![alt text](./devops/20.png)<br>

### Если ошибок нет, то командой ip -4 a проверить, что адрес машины задан верно.

- ```WS11```<br>
![alt text](./devops/21.png)<br>

- ```R1```<br>
![alt text](./devops/22.png)<br>

- ```WS21```<br>
![alt text](./devops/23.png)<br>

- ```WS22```<br>
![alt text](./devops/24.png)<br>

- ```R2```<br>
![alt text](./devops/25.png)<br>

### Пропинговать ws22 с ws21. Аналогично пропинговать r1 с ws11.

- ```WS22 c WS21```<br>
![alt text](./devops/26.png)<br>

- ```R1 c WS11```<br>
![alt text](./devops/27.png)<br>

### 5.2. Включение переадресации IP-адресов.
- ```sysctl -w net.ipv4.ip_forward=1 на роутерах```<br>
![alt text](./devops/28.png)<br>

- ```net.ipv4.ip_forward=1 в /etc/sysctl.conf на роутерах```<br>
![alt text](./devops/29.png)<br>

### 5.3. Установка маршрута по-умолчанию

Скрины etc/netplan/00-installer-config.yaml:<br>
- ```WS11 netplan```<br>
![alt text](./devops/30.png)<br>

- ```WS21 netplan```<br>
![alt text](./devops/31.png)<br>

- ```WS22 netplan```<br>
![alt text](./devops/32.png)<br>

- ```Скрин выполнения команды ip r```<br>
![alt text](./devops/33.png)<br>

- ```Пропинговали r2 с ws11```<br>
![alt text](./devops/34.png)<br>

### 5.4. Добавление статических маршрутов

- ```netplan роутеров:```<br>
![alt text](./devops/36.png)<br>

- ```Маршруты роутеров: (ip r)```<br>
![alt text](./devops/35.png)<br>

- ```ip r list 10.10.0.0/[маска сети] и ip r list 0.0.0.0/0```<br>
![alt text](./devops/37.png)<br>
